...
class TravelUIDistance extends React.Component {
  constructor (props) {
    ...
    this.state = {
      ...
      // currentdestinationkey: this.props.DestinationClass.getDestination().id,
    }
  }
...
render(){ 
  ...
  return (
    ...
    <div>
      ...
      <img className="arrival-image" src={this.props.DestinationClass.getCurrentDestination().imgurl} alt="View of destination."/>
    </div>
